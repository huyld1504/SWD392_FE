...
export default function RegisterPage() {
  ...
  const { mutate: registerUser, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      ...
      navigate(
        data.user.role === 'LECTURE' ? '/lecture/dashboard' : '/student/dashboard',
      );
    },
    onError: (err: unknown) => {
      const message =
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <User size={18} />
                    <span className="font-medium text-sm">Sinh viên</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setValue('role', 'LECTURE')}
                    className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg border-2 transition-all ${
                  ...
                  >
                    <User size={18} />
                    <span className="font-medium text-sm">Giảng viên</span>
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-all ${
              ...
              >
                {isPending ? 'Đang đăng ký...' : 'Create account'}
              </button>
